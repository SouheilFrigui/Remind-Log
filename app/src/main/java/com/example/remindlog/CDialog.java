...
/*public class CDialog extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try
        {
            ...
            View popupView = layoutInflater.inflate(R.layout.dialog_clone, R.style.AlertDialogTheme);
            ...
            while (managedCursor.moveToNext()) {
                ...
                int call_code = Integer.parseInt(callTypeCode);
                switch (call_code) {
            ...
            tv_client.setText(""+phone_no +" called you");
            relation.setText(sb);
